    ...
    case 'tokyo-anime-cafes':
      return [
        ...
        },
        {
          ...
          href: `https://www.booking.com/searchresults.html?ss=Shinjuku%2C+Tokyo&aid=${baseBookingId}`,
    ...
    case 'osaka-anime-guide':
      return [
        ...
        },
        {
          ...
          buttonText: 'Search Hotels',
          href: `https://www.booking.com/searchresults.html?ss=Namba%2C+Osaka&aid=${baseBookingId}`,
          program: 'booking' as const,
          category: 'area-guides',
        },
        {
