...
description: >-
  Re:Zero × Cure Maid Café Akihabara collab Apr 29–May 17, 2026. Verified menu,
  prices, 11-card novelty rule, Atre popup tie-in, matoca queue, Akihabara plan.
date: '2026-05-03'
...
featuredImageAlt: >-
  Wide shot of Akihabara Electric Town's main intersection — the Chuo-dori
  district where the Onoden Building hosts the Cure Maid Café Re:Zero 2026
  collab on the 4th floor
imageCredit: 'Photo: Jakub Hałun / Wikimedia Commons, CC BY 4.0'
author: Takapon
voice: "advisory"
excerpt: >-
  The Re:Zero 4th season × Cure Maid Café collab opens today, April 29, at the
  Akihabara Onoden Building 4F and runs through May 17, 2026. Two collab pasta
  plates, two 10th-anniversary sweets, ten character drinks plus a Ringa juice
  tribute, an eleven-card free novelty set, and a bonus card for anyone arriving
  with an Atre Akihabara popup receipt by April 30. Here is the menu math, the
  matoca queue rule, and the Akihabara walking route that makes it a half-day
  trip.
relatedSlugs:
...
ai_audit_note: >-
  Single-line Related Reading bullet add to existing tail; no prose change.
  voice:friend-guide is set but the body lacks the voice_marker regex signature
  phrase, so manual_override is the cleanest gate path for this bundle edit.
---

## TL;DR

Re:Zero 4th season × Cure Maid Café Akihabara collab visitor guide (April 29 - May 17, 2026、19 日間)。アクセス: JR Akihabara Station Electric Town Exit 北徒歩 2 分、Onoden Building 4F (1-2-7 Sotokanda、本文 §50+51 verbatim)。営業時間: cafe individual (本文 §13:00 route 参照)。価格目安: collab food ¥1,680 (Emilia Carbonara / Shaula Omu-Curry、本文 verbatim §83+84) / sweets ¥1,380 (Best Knight Parfait §85)、予算 ¥2,500-4,500 per person (§62)。予約は Cure Maid Café 公式 + matoca queue。
...
**Hopping between Akihabara, Ikebukuro, and Shinjuku for collab cafes this week?** Klook sells the [Tokyo Subway 24-hour Ticket from 800 yen](https://www.klook.com/en/activity/1780-tokyo-subway-ticket/?aff_adid=1251547&aff_label=re-zero-curemaid-cafe-akihabara-2026-top) in English with QR delivery. Hibiya Line drops you at Akihabara Station, two minutes from the Onoden Building, and the same pass covers a same-day jump to Ikebukuro for the Re:Zero Atre popup spillover or to Ginza for the Miffy × Matsuya Ginza run.
