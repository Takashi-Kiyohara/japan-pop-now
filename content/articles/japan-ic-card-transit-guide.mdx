...
heroImageAlt: "Suica IC card on a Tokyo station ticket gate reader, the core travel tool for every first-time visitor in 2026"
...
![Suica IC card on a Tokyo station ticket gate reader, the core travel tool for every first-time visitor in 2026](/images/articles/japan-ic-card-transit-guide/hero.webp)
*An IC card (contactless transit card) turns every Tokyo, Osaka, and Kyoto train gate into a single tap. 2026 update: the new Welcome Suica Mobile app replaces the paper-form tourist card at most ticket counters.*
...
![Mobile IC card on a smartphone tapping a station gate reader in Tokyo 2026](/images/articles/japan-ic-card-transit-guide/body-mobile.webp)
*Mobile IC on iPhone — the FeliCa chip sits near the top of the phone, which is why you tap the top edge against the blue reader rather than the middle of the screen.*
...
![Convenience store IC card charging terminal at 7-Eleven Tokyo 2026](/images/articles/japan-ic-card-transit-guide/body-charging.webp)
*Konbini (convenience store) top-up is the simplest way to recharge. Hand the card to the cashier, say "charge", and pay cash. Works at 7-Eleven, Lawson, and FamilyMart nationwide.*
...
- Hero, body-mobile, body-charging: Japan Pop Now editorial illustrations, 2026. CC-BY-4.0. Replace with Takapon inbox IC card photos or Wikimedia Commons CC-BY Suica images before publish if available.
- Suggested Wikimedia alternatives: [Suica card file on Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Suica.jpg), [Japanese convenience store charging terminal](https://commons.wikimedia.org/wiki/Category:7-Eleven_Japan).
