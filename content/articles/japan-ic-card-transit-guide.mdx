...
<HowToSchema
  name="Set up a Mobile IC card on iPhone for Japan travel"
  steps={[
    { name: "Update iOS", text: "Update to iOS 17.2 or later. Go to Settings, General, Software Update." },
    { name: "Download the app", text: "Install the free Welcome Suica Mobile app from the App Store. Search for 'Welcome Suica Mobile' in English." },
    { name: "Sign up with email", text: "Open the app, tap Sign Up, enter an email address, and confirm the verification code. A Japanese Apple ID is not required." },
    { name: "Issue the card", text: "Tap Issue New Card, accept the terms, and choose a starting balance (minimum 1,000 yen). The card is created instantly." },
    { name: "Top up with credit card", text: "Add a Visa or Mastercard (foreign cards are accepted). Enter the amount and confirm. The balance appears on your card within 5 seconds." },
    { name: "Tap at the gate", text: "At any train or bus gate, hold the top of your iPhone flat against the blue reader. A chime confirms entry. You do not need to open the app." }
  ]}
/>
...
<FAQSchema
  faqs={[
    {
      question: "Can I use my Suica balance on a future trip to Japan?",
      answer: "For physical Suica, Pasmo, and ICOCA, yes — the card stays valid for 10 years from the date of last use, and the balance stays on the card between trips. For the Welcome Suica Mobile app, the balance is valid for 180 days from issuance; if you return within that window, the balance is still there, but after 180 days it is forfeited."
    },
    {
      question: "Does the Welcome Suica Mobile app need a Japanese phone number or Apple ID?",
      answer: "No. The Welcome Suica Mobile app supports English, does not require a Japanese Apple ID, and lets you sign up with any email address. You need an iPhone running iOS 17.2 or later (iPhone 8 or newer) and a Visa or Mastercard for top-ups."
    },
    {
      question: "Can Android phones bought outside Japan use Mobile Suica?",
      answer: "Usually not. Mobile Suica requires the FeliCa contactless chip, which is only built into Android phones sold in the Japanese market. A Pixel, Galaxy, or Xiaomi phone bought in the US, UK, Europe, or Asia outside Japan almost certainly does not have FeliCa, so Mobile Suica will not appear in Google Wallet. Buy a physical Welcome Suica or Pasmo Passport at the airport counter instead."
    },
    {
      question: "What happens if my IC card balance runs out mid-journey?",
      answer: "You can still exit the station using the fare adjustment machine (seisanki) next to every ticket gate. Insert the card, add cash for the difference, and the machine updates your card. The gate then opens with a normal tap. No penalty, no paperwork."
    },
    {
      question: "Can I use an IC card on the Shinkansen bullet train?",
      answer: "A regular IC card does not work on Shinkansen gates — you need a separate Shinkansen ticket or a Japan Rail Pass. The exception is Mobile Suica linked to the Smart EX app (or, from spring 2026, the new Welcome Suica Mobile app linked to JR East Train Reservation), which lets you buy Shinkansen e-tickets on your phone."
    },
    {
      question: "Is there a 7-day unlimited Suica pass for tourists?",
      answer: "As of May 2026, no — the Welcome Suica Mobile app is a pay-as-you-go card, not an unlimited pass. Every ride still deducts its fare from your balance. For flat-rate travel, consider the Tokyo Subway 24, 48, or 72-hour pass (Tokyo Metro only) or the Japan Rail Pass (JR nationwide)."
    }
  ]}
/>
