---
title: "Tokyo Collab Cafes Summer"
description: "Book Tokyo summer anime collab cafes 2026: Haikyuu Animate, Maid-sama, June-August rotations, multi-cafe routes & reservation systems."
date: "2026-04-05"
...
excerpt: "Book Tokyo summer anime collab cafes 2026: Haikyuu Animate, Maid-sama, June-August rotations, multi-cafe routes & reservation systems."
relatedSlugs: []
wpPostId: 752
---
...
![Anime collaboration cafe interior in Tokyo with themed food drinks and character decorations on display]()Tokyo’s collab cafe scene rotates constantly — there are usually 15-20 anime-themed cafes running at any given time across the city. Photo: Japan Pop Now
...
**Lottery reservation (æ½é¸äºç´):** You apply during a window (usually opening 2 weeks before the collab starts) and get randomly selected. Results are emailed. This is the method for the first week of popular collabs when demand is highest.

**Seat reservation (ç©ºå¸­äºç´):** Real-time availability booking for remaining seats after the lottery period. First-come-first-served. This is where most overseas visitors end up booking — the lottery is competitive, but open seats appear regularly after the first week.
...
BOX CAFE runs collab events at multiple Tokyo venues (often in Shinjuku, Omotesando, and department store rooftops). Many BOX CAFE events use Loppi (Lawson’s in-store kiosk) for ticket distribution, which means you need to physically visit a Lawson convenience store in Japan to book. For alternatives, see our [overseas booking guide](/book-japan-anime-events-overseas-2026/) — proxy booking services can handle Loppi reservations on your behalf.
...
| **Main dish** | Â¥1,200-1,990 (~$8-14) | Themed character plates, curry, pasta, etc. |
| **Dessert** | Â¥800-1,200 (~$5-8) | Character parfaits, themed cakes |
| **Drink** | Â¥700-990 (~$5-7) | Often comes with a random coaster or charm |
| **Merchandise (optional)** | Â¥1,100-2,200 (~$7-15) | Acrylic stands, coasters, mugs, clear files |
| **Typical total per person** | Â¥2,500-4,500 (~$17-31) | Food + drink + 1 merch item |
...
The real spending trap is merchandise. Every collab cafe sells exclusive goods — acrylic stands (Â¥1,100), coasters (Â¥550), mugs (Â¥2,200), clear files (Â¥440) — that are only available during that specific collab run. If your favorite character is featured, budget an extra Â¥2,000-5,000 for merch you’ll want to take home.
