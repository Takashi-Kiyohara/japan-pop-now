...
Most first-time anime tourists lose their first 24 hours in Japan to the same four mistakes: no IC card, no SIM, a suitcase they are dragging through Shibuya, and a pocket full of yen they did not actually need. I have watched this play out in person more than 40 times with friends flying in from the US, UK, Singapore, and Brazil. The ones who recover fast all did the same boring preparation the week before they flew.
...
- [The 3-Hour Arrival Plan (Narita / Haneda)](#arrival-plan)
- [What to Book Before You Fly](#book-before)
- [What to Grab at the Airport](#at-the-airport)
...
| Item | Detail |
|---|---|
| Best airports | Haneda (HND) for Tokyo, Narita (NRT) as backup |
| IC card options | Welcome Suica (Narita), PASMO Passport (Haneda), or mobile Suica via Apple/Google Wallet |
| Typical airport to Shinjuku cost | Narita Express approx 3,250 yen, Skyliner + subway approx 2,700 yen, Haneda Monorail + JR approx 660 yen |
| Cash to carry | 10,000 yen minimum, refill at konbini ATMs |
| eSIM pre-order | 7 to 14 days of data for approx 2,500 to 5,000 yen |
| Collab cafe reservation window | 2 to 4 weeks out, Japanese-only flow |
| Power outlet | Type A, 100V, no adapter needed for most US plugs |
| Tipping | Not practiced; do not tip in restaurants or taxis |
| Tap water | Safe to drink in every major city |
...
Yes, but most reservation portals are Japanese-only and require a Japanese phone number for SMS verification. Workarounds include using Klook's English-language reservation partner or booking through a concierge service. Our [collab cafe booking guide](/articles/how-to-book-anime-collab-cafe-japan) explains the exact steps.
